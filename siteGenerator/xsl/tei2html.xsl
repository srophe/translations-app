<xsl:stylesheet xmlns="http://www.w3.org/1999/xhtml" 
 ...
 <!-- =================================================================== -->
    ...
    <xsl:template match="t:bibl">
        <xsl:choose>
            <xsl:when test="ancestor-or-self::t:msItem"><xsl:apply-templates select="." mode="mssBibl"/></xsl:when>
            ...
            <xsl:when test="parent::t:note or parent::t:handNote or parent::t:p or parent::t:decoNote">
                <xsl:choose>
    ...
    <xsl:template match="t:note">
        ...
        <xsl:choose>
            ...
            <xsl:when test="@type='footnote'"><xsl:text>*</xsl:text></xsl:when>
            <xsl:otherwise>
                <div class="tei-note">  
                    <xsl:choose>
    ...
    <xsl:template match="t:placeName | t:title | t:persName | t:term" mode="list">
        ...
        <xsl:choose>
            <xsl:when test="ancestor::t:msDesc">
